...
import com.example.dailyexpenseapp.model.Data;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Expense List").child(uId);
    ...
    private void customDialog() {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Data data = new Data(mType,ammint,mNote,date,id); // Data is from Model Data class i.e Class Data object data
